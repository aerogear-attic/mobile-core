...
image::images/client-info-1.png[client info defails]
...
image::images/client-delete-1.png[delete client secret]

Then delete it by clicking on `Edit > Delete` in the client app secret detail page:

image::images/client-delete-2.png[delete client secret]
