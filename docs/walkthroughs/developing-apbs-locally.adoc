...
An example of this can be seen in the Keycloak APB, link:https://github.com/aerogearcatalog/keycloak-apb/blob/master/roles/bind-keycloak-apb/tasks/main.yml#L107-L119[here]. These annotations should be link:https://github.com/aerogearcatalog/keycloak-apb/blob/master/roles/unbind-keycloak-apb/tasks/main.yml#L48-L60[removed on unbind]. 
